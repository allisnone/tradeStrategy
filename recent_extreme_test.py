...
if __name__ == '__main__': 
    ...
    for code in codes:
        ...
        over_ma5_rate,continue_over_ma5_num,date_last=stock_hist_obj.get_recent_over_ma(ma_type='ma5',ma_offset=0.002,recent_count=20)
        over_ma10_rate,continue_over_ma10_num,date_last=stock_hist_obj.get_recent_over_ma(ma_type='ma10',ma_offset=0.002,recent_count=40)
        ...
        if True:#over_ma_rate>0.75 and continue_over_ma_num:
            code_data={'code':code,'date':date_last,'o_ma5_rate':over_ma5_rate,'ct_o_ma5_num':continue_over_ma5_num,'o_ma10_rate':over_ma10_rate,'ct_o_ma10_num':continue_over_ma10_num,'reversal':actual_turnover_rate,'extreme':continue_extreme_num}
