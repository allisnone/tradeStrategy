...
if __name__ == '__main__': 
    data={}
    stronge_ma_3_list=[]
    result_column=['code','o_ma5_rate','ct_o_ma5_num','o_ma10_rate','ct_o_ma10_num','reversal','extreme']
    ...
    for code in codes:
        ...
        is_drop_up,actual_turnover_rate=stock_hist_obj.is_drop_then_up(great_dropdown=-3.0,turnover_rate=0.75,turnover_num=2)
        ...
        if True:#over_ma_rate>0.75 and continue_over_ma_num:
            code_data={'code':code,'o_ma5_rate':over_ma5_rate,'ct_o_ma5_num':continue_over_ma5_num,'o_ma10_rate':over_ma10_rate,'ct_o_ma10_num':continue_over_ma10_num,'reversal':actual_turnover_rate,'extreme':continue_extreme_num}
